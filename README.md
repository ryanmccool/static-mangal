...
> **Fork maintainers:** See the [repository documentation](docs/README.md) for the current static architecture review, codebase catalog, maintenance guidance, and recommended technical direction.
